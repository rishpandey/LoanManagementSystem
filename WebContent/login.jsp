        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li>
                        <a href="ratesTable.html">Interest Rates</a>
                    </li>
                    <li>
...
<table>
                 ...
                 <tr>
                   <td><input type="checkbox" checked="checked"> Remember me</td></tr>
                   <tr>
                  <td><span class="psw">Forgot <a href="Forgotpass.html">password?</a></span></td>
